...
`;var c=t(4316),g=t(2718),u=t(9968),m=t(3226),y=t(9427),h=t(3649),f=t(579);const M=()=>{const{savedMovies:e,addMovieToSaved:i,removeMovieFromSaved:t,savedMoviesLoading:M}=(0,y._)(),{state:p}=(0,d.useContext)(u.B),[x]=(0,v.ok)(),[A,S]=(0,d.useState)(""),[I,j]=(0,d.useState)({title:"",ids:[]}),[w,b]=(0,d.useState)("100vh"),{showNotification:C,NotificationComponent:$}=(0,h.i)(),{loading:k,error:D,data:B}=(0,o.IT)(l,{variables:{ids:I.ids}});(0,d.useEffect)((()=>{const e=x.get("ids").split(",").map((e=>+e)),i=x.get("title");j({title:i,ids:e})}),[x]),(0,d.useEffect)((()=>{const e=document.querySelector("header"),i=document.querySelector("footer");if(e){const t=e.offsetHeight,o=i.offsetHeight;b(`calc(100vh - ${t+o}px)`)}}),[]);return D?(console.log(`error in recommendation page: ${D}`),(0,f.jsx)(c.gP,{})):(0,f.jsxs)(a.A,{sx:{minHeight:w,display:"flex",flexDirection:"column",alignItems:"center",padding:3,backgroundColor:"#f5f5f5"},children:[(0,f.jsx)(c.hH,{user:p.user||null,isPreviewMode:!0,title:A,movieId:A,open:!!A,onClose:()=>{S("")},addFavoriteMovie:async e=>{await i(e)?C((0,f.jsx)(m.A,{id:"notification.movie_add_to_favorite_successfully"}),"success",1e3,{vertical:"bottom",horizontal:"right"}):C("Error in saving movie","error",5e3,{vertical:"bottom",horizontal:"right"})},removeFavoriteMovie:async e=>{await t(e)?C((0,f.jsx)(m.A,{id:"notification.movie_removed_successfully"}),"success",1e3,{vertical:"bottom",horizontal:"right"}):C("Error in removing movie","error",5e3,{vertical:"bottom",horizontal:"right"})},savedMovies:e,savedMoviesLoading:M}),(0,f.jsx)(r.A,{variant:"h4",gutterBottom:!0,children:I.title?I.title:"Recommended Movies"}),(0,f.jsx)(s.Ay,{item:!0,xs:12,md:8,sx:{width:"100%"},children:(0,f.jsx)(n.A,{sx:{padding:2,minHeight:"400px"},children:(0,f.jsxs)(a.A,{sx:{flexGrow:1},children:[k&&(0,g.A)({favoriteMode:!0}),B&&(0,f.jsx)(s.Ay,{container:!0,spacing:2,children:B.moviesByIds.map((e=>(0,f.jsx)(s.Ay,{item:!0,xs:12,md:3,lg:2,children:(0,f.jsx)(c.NU,{movie:e,onCardSelect:()=>console.log("onCardSelect"),openMovieDetailsById:S,isPreviewMode:!0})},e.id)))})]})})}),$]})}},2718:(e,i,t)=>{t.d(i,{A:()=>s});var o=t(8903),a=t(7121),r=t(579);const s=e=>{let{favoriteMode:i=!1}=e;return(0,r.jsx)(o.Ay,{container:!0,spacing:2,children:Array.from(new Array(8)).map(((e,t)=>(0,r.jsxs)(o.Ay,{item:!0,xs:12,md:i?3:4,lg:i?2:3,children:[(0,r.jsx)(a.A,{variant:"rectangular",height:431}),(0,r.jsx)(a.A,{variant:"text",height:32}),(0,r.jsx)(a.A,{variant:"text",height:32})]},t)))})}}}]);
//# sourceMappingURL=323.05084403.chunk.js.map